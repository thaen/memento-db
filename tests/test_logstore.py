...
def test_reopen_and_recover():
    ...
    for k, v in keys.items():
        pass  # TODO: assert all values present after recovery
...
def test_tombstone_survives_reopen():
    ...
    reopened = LogStore.open(disk)
    pass  # TODO: delete must survive recovery
...
def test_last_write_wins():
    ...
    pass  # TODO: latest write wins after reopen
...
def test_roundtrip_matches_model(op_list):
    ...
    for k in keys_seen(op_list):
        pass  # TODO: assert reopened matches the model for k
...
def test_torn_trailing_record_is_dropped():
    ...
    pass  # TODO: good1 and good2 survive; partial is dropped (None)
...
def test_torn_at_every_byte_offset(chop):
    ...
    pass  # TODO: the survivor (keep) is always intact
